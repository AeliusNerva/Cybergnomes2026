...
public class BallGuidance {
	...
	// Takes the relative position and velocity and calculates the required ball
	// velocity to land in the hub
	...
	public static Vector3 get_turret_instructions(Vector3 velocity_vector) {
		...
		// Get magnitude of x and z axes (lateral) then arctangent with vertical
		// velocity to get pitch
